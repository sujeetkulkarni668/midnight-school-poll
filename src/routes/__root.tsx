...
import { RuntimeBanner } from "@/components/poll/RuntimeBanner";
import { PhaseOverlay } from "@/components/poll/PhaseOverlay";
import { PollAppProvider, usePollApp } from "@/hooks/use-poll-app";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Private Campus Poll" },
      { name: "description", content: "Zero-knowledge campus voting on Midnight." },
...
function PhaseGate() {
  const { phase } = usePollApp();
  return <PhaseOverlay phase={phase} />;
}
